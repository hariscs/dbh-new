...
The District Behavioral Health public website: a headless WordPress frontend
built with Next.js 16. WordPress (on the `cms.` subdomain) stays the content
backend; this app renders its pages via a custom Builder API with SSG + ISR,
and deploys as a standalone artifact to EC2 via GitHub Actions.
