              ...
              <div className="cards-wrapper">
                <div className="cards" role="list">
                  <article className="card" role="listitem" style={{"display":"block"}}>
                    <Link href="/location-served/usa/fentanyl-addiction-treatment/addiction/">
                      <h3>
                        {drug} Addiction Treatment Centers at District Behavioral Health
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"block"}}>
                    <Link href="/location-served/usa/fentanyl-addiction-treatment/withdrawal/">
                      <h3>
                        {drug} Withdrawal Symptoms, Timeline, and Detox Treatment
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"block"}}>
                    <Link href="/location-served/usa/fentanyl-addiction-treatment/">
                      <h3>
                        Best {drug} Rehab Across the Country (Highly Reviewed & Awarded)
                      </h3>
                    </Link>
                  </article>
                </div>
