          ...
          <div className="elementor-element elementor-element-661e026 elementor-widget elementor-widget-heading" data-widget_type="heading.default">
            <div className="elementor-widget-container">
              <h2 className="elementor-heading-title elementor-size-default">
                Combined Anxiety & Depression Screening Assessment
              </h2>
            </div>
          </div>
            ...
            <div className="elementor-widget-container">
              ...
              <p>
                <strong>
                 ...
                 This combined assessment serves as a self-screening instrument to help you map out your symptoms. It is not a definitive clinical diagnosis. Please share your results with a doctor or mental health professional for an accurate, comprehensive health evaluation.
              </p>
            </div>
          </div>
        </div>
