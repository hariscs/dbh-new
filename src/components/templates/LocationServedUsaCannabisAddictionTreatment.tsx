...
export default function LocationServedUsaCannabisAddictionTreatment(props: Record<string, string>) {
  ...
  <div className="elementor elementor-2841 elementor-location-single post-105139 page type-page status-publish hentry geo-national intent-medium marketing-channel-seo template-blog template-cro1 topic-cannabis topic-2-withdrawal">
              ...
              <div className="elementor-widget-container">
                <div className="elementor-post-navigation" role="navigation" aria-label="Post Navigation">
                  <div className="elementor-post-navigation__prev elementor-post-navigation__link">
                    <Link href="/location-served/usa/butalbital-addiction-treatment/withdrawal/" rel="prev">
                  ...
                  <div className="elementor-post-navigation__next elementor-post-navigation__link">
                    <Link href="/location-served/usa/clonazepam-addiction-treatment/withdrawal/" rel="next">
                    ...
                    <li className="elementor-toc__list-item">
                      <div className="elementor-toc__list-item-text-wrapper">
                        <Link href="#elementor-toc__heading-anchor-3" className="elementor-toc__list-item-text elementor-toc__top-level">
                          Quitting Cold Turkey: Tips for Quitting
                        </Link>
                      </div>
                    </li>
                    <li className="elementor-toc__list-item">
                    ...
                    <li className="elementor-toc__list-item">
                      <div className="elementor-toc__list-item-text-wrapper">
                        <Link href="#elementor-toc__heading-anchor-9" className="elementor-toc__list-item-text elementor-toc__top-level">
                          Get Treatment for Addictions and Mental Health Disorders at District Behavioral Health Group
                        </Link>
                      </div>
                    </li>
                    <li className="elementor-toc__list-item">
    ...
    <RelatedLinks
      ...
      description={(props.blog_section_4___con && <div dangerouslySetInnerHTML={{ __html: props.blog_section_4___con }} />) ?? null}
      cards={[
        { href: '/location-served/usa/cannabis-addiction-treatment/addiction/', title: <>Cannabis Use Disorder: Signs of Marijuana Addiction & Treatment</> },
      ]}
    />
