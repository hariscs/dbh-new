              ...
              <div className="cards-wrapper">
                <div className="cards" role="list">
                  <article className="card" role="listitem" style={{"display":"block"}}>
                    <Link href="/location-served/usa/meth-addiction-treatment/crystal-meth-addiction-treatment/withdrawal/">
                      <h3>
                        Crystal Meth {topic_2} Symptoms, Timeline, and Effects
                      </h3>
                    </Link>
                  </article>
                  <article className="card" role="listitem" style={{"display":"block"}}>
                    <Link href="/location-served/usa/meth-addiction-treatment/addiction/">
                      <h3>
