...
export default function LocationServedUsaMarijuanaAddictionTreatment(props: Record<string, string>) {
  const postDate = formatPostDate(props.createdAt);
  const postCategory = formatPostCategory(props);
  const h1 = props.h1 ?? "How to Recover From Edibles? 10 Tips to Quick Recovery";
  const address_county = props.address_county ?? "Orange County";
  return (
    <>
    <div className="wp-singular page-template-default page page-id-3217 page-child parent-pageid-1779 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor wp-child-theme-hello-theme-child-master hello-elementor-default elementor-default elementor-kit-7 elementor-page elementor-page-3217 elementor-page-2841 e--ua-blink e--ua-chrome e--ua-mac e--ua-webkit">
  <Link className="skip-link screen-reader-text" href="#content">
    Skip to content
  </Link>
  <div className="elementor elementor-2841 elementor-location-single post-3217 page type-page status-publish hentry geo-national intent-medium marketing-channel-seo template-blog template-cro1 topic-edibles topic-2-info">
              ...
              <div className="elementor-widget-container">
                <div className="elementor-post-navigation" role="navigation" aria-label="Post Navigation">
                  <div className="elementor-post-navigation__prev elementor-post-navigation__link">
                    <Link href="/location-served/usa/dopamine/benefits-working/" rel="prev">
                  ...
                  <div className="elementor-post-navigation__next elementor-post-navigation__link">
                    <Link href="/location-served/usa/ativan-lorazepam/how-long-in-your-system/" rel="next">
              ...
              <div className="elementor-widget-container">
                ...
                <div id="elementor-toc__8fec590" className="elementor-toc__body elementor-toc__list-items--collapsible">
                  <ol className="elementor-toc__list-wrapper">
                    ...
                    <li className="elementor-toc__list-item">
                      <div className="elementor-toc__list-item-text-wrapper">
                        <Link href="#elementor-toc__heading-anchor-3" className="elementor-toc__list-item-text elementor-toc__top-level">
                          Why Do People Overconsume Cannabis Edibles?
                        </Link>
                      </div>
                    </li>
                    <li className="elementor-toc__list-item">
                    ...
                    <li className="elementor-toc__list-item">
                      <div className="elementor-toc__list-item-text-wrapper">
                        <Link href="#elementor-toc__heading-anchor-5" className="elementor-toc__list-item-text elementor-toc__top-level elementor-item-active">
                    ...
                    <li className="elementor-toc__list-item">
                      <div className="elementor-toc__list-item-text-wrapper">
                        <Link href="#elementor-toc__heading-anchor-6" className="elementor-toc__list-item-text elementor-toc__top-level">
                          How to Recover From Edibles: 10 Helpful Strategies
                        </Link>
                      </div>
                    </li>
                    <li className="elementor-toc__list-item">
                    ...
                    <li className="elementor-toc__list-item">
                      <div className="elementor-toc__list-item-text-wrapper">
                        <Link href="#elementor-toc__heading-anchor-8" className="elementor-toc__list-item-text elementor-toc__top-level">
                          Get Treatment for Addiction at District Behavioral Health
                        </Link>
                      </div>
                    </li>
                  </ol>
