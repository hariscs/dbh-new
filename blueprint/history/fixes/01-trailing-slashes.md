...
> **Archived retroactively on 2026-08-31.** This fix was merged into `main`
> from branch `fix/link-trailing-slashes` via PRs #14, #15 and #16, but
> `/complete` was never run, so the spec stayed in `current-feature.md` instead
> of being archived here. Recovered from git history unchanged; only this note
> was added.
